        ...
        <header className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-white/10">
            <div className="w-full px-6 flex items-center justify-between py-4">
                <div className="flex items-center gap-4">
                    {/* Mobile Browse Link (Icon) - Visible only on small screens */}
                    <Link to="/venues" className="md:hidden p-2 text-white hover:text-[#ffd700] transition-colors">
                ...
                <div className="hidden md:flex items-center gap-3">
                    <Link to="/venues" className="bg-blue-600 hover:bg-blue-500 text-white font-bold px-4 py-2 rounded-lg transition-all shadow-lg hover:shadow-blue-500/20 active:scale-95 whitespace-nowrap">
